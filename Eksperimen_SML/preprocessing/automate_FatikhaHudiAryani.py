...
if __name__ == "__main__":
    raw_path = "insurance-raw.csv"
    save_pipeline_path = "preprocessor.joblib"
    save_header_path = "insurance_preprocessing/columns.csv"
    save_dataset_path = "insurance_preprocessing"
